    ...
    <main className="min-h-full px-6 md:px-12 py-8 md:py-12 pb-24">
                    <article className="max-w-[1024px] w-full mx-auto">
                        <h1 className="text-[32px] md:text-[36px] font-semibold text-gray-900 tracking-tight leading-tight mb-4">
                            AI Analytics</h1>
                        <p className="text-[18px] md:text-[20px] font-medium text-[#2563eb] mb-6 leading-snug">AI-native
                            test analytics for smarter reporting</p>
                        <p className="text-[16px] text-gray-600 leading-[1.6] mb-12 max-w-[900px]">Gain data-driven insights
                            into test performance, risk scoring, and quality trends. The dashboard features a Score
                            &amp; Pass Rate Trend graph, a Coverage Radar mapping out Functional/SEO/Accessibility
                            coverage, and detailed distribution charts for test results and risks.</p>
                        ...
                        <div className="relative cursor-zoom-in group bg-white rounded-xl border border-gray-200 overflow-hidden shadow-sm hover:shadow-md transition-shadow">
                            ...
                            <div className="relative w-full"><img alt="AI Analytics screenshot" fetchPriority="high" width="1024" height="640" decoding="async" data-nimg="1" className="w-full h-auto transition-transform duration-500 group-hover:scale-[1.01]" style={{"color":"transparent"}} src="/images/ai-analytics-1.png" /></div>
